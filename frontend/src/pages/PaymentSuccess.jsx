...
import { CheckCircle2, Home, History, Printer, MapPin, Phone, Mail, QrCode } from 'lucide-react';
...
const PaymentSuccess = () => {
    ...
    useEffect(() => {
        if (orderCode) {
            ...
            // Lấy thông tin chi tiết đơn hàng để in hóa đơn
            fetch(`http://localhost:3000/api/bookings/${orderCode}`, {
                ...
                <div className="p-10 md:p-12 space-y-10 text-left">
                    ...
                    <div className="hidden print:flex justify-between items-center pt-10 mt-10 border-t border-slate-100">
                        ...
                        <div className="flex flex-col items-center">
                            <div className="w-16 h-16 border border-slate-100 rounded-lg flex items-center justify-center mb-2 text-left">
