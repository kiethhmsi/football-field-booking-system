...
export default function Matchmaking() {
  ...
  if (loading) {
    return <div className="flex items-center justify-center min-h-screen font-black italic uppercase tracking-widest text-emerald-800">Đang tìm đối thủ...</div>;
  }
    ...
    <div className="bg-white min-h-screen">
      ...
      <section className="bg-emerald-50/30 pt-16 pb-12 px-6 md:px-12 border-b border-gray-100">
        <div className="max-w-6xl mx-auto text-left">
          ...
          >
            Tìm đối thủ <span className="text-emerald-600 underline decoration-emerald-200 underline-offset-8">giao lưu</span>
          </motion.h2>
          <p className="max-w-2xl text-gray-500 font-medium leading-relaxed font-sans">
            Kết nối với các đội bóng trong khu vực, so tài kỹ năng và cháy hết mình trên sân cỏ cùng HKSPORT Complex.
          </p>
        </div>
      </section>
             ...
             <div className="flex-1">
                <div className="flex flex-col md:flex-row gap-10 items-center justify-between mb-10">
                   <div className="text-gray-400 text-[10px] font-black uppercase tracking-[0.2em] text-left">
                     ĐANG HIỂN THỊ <span className="text-emerald-700 font-black">{matches.length} KÈO ĐẤU</span> PHÙ HỢP
                   </div>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 relative">
                  ...
                  <div className="bg-emerald-800 rounded-[2.5rem] p-8 md:p-12 text-white flex flex-col justify-between relative overflow-hidden group shadow-xl shadow-emerald-100 min-h-[350px] text-left">
                    <div className="relative z-10">
                      <h3 className="text-3xl font-black mb-4 max-w-[250px] italic uppercase tracking-tighter leading-none">Bạn không tìm thấy đối thủ phù hợp?</h3>
                      <p className="text-emerald-100/60 text-sm leading-relaxed mb-8 max-w-[300px] font-medium font-sans">
                        Hãy tạo kèo riêng của bạn và để HKSPORT tự động kết nối với những đội bóng tương xứng.
                      </p>
                    </div>
                    
                    <Link to="/create-match-booking" className="relative z-10 w-fit text-decoration-none">
                      <motion.button
