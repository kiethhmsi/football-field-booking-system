...
const AppContent = () => {
    ...
    return (
        ...
        {/* HEADER CHỈ HIỆN Ở TRANG KHÁCH HÀNG */}
        {!isAdminMode && (
            <header style={{ backgroundColor: 'var(--bg-white)', padding: '15px 0', borderBottom: '1px solid var(--border-color)' }}>
                <div className="container d-flex justify-between align-center">
                    ...
                    <nav className="d-flex gap-2">
                        ...
                        <Link to="/admin" style={{ textDecoration: 'none', color: '#ef4444', fontWeight: 500 }}>Vào CMS Admin (Ẩn)</Link>
                    </nav>
        ...
        <main style={{ minHeight: isAdminMode ? '100vh' : '75vh' }}>
            <Routes>
        ...
        {/* FOOTER CHỈ SHOW VỚI KHÁCH HÀNG */}
        {!isAdminMode && (
